...
public class DeleteTest {
	@Test
	public void deleteUser() throws ParseException, IOException{
		String url = "http://localhost:8080/usercrud/rest/account/delete";
		BufferedReader in=null;
		try
		{
			URL obj = new URL(url);
			HttpURLConnection con = (HttpURLConnection) obj.openConnection();
			String urlParameters = "username=adminins";
